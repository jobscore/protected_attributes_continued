...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "activemodel",  ">= 7.2", "<= 8.0.2"

  gem.add_development_dependency "activerecord", ">= 7.2", "<= 8.0.2"
  gem.add_development_dependency "actionpack",   ">= 7.2", "<= 8.0.2"
  gem.add_development_dependency "railties",   ">= 7.2", "<= 8.0.2"
